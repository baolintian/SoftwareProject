...
class ImageConstants:
    ...
    IMAGEHOLE_CHANGE       = IMAGEBASE + "hole1.png"
    IMAGEMALLET     = IMAGEBASE + "mallet1.png"
    IMAGEPLAYERA = IMAGEBASE + "playera.png"
    IMAGEPLAYERB = IMAGEBASE + "playerb.png"
